...
public class BikePropertiesDTO {
    ...
    public BikePropertiesDTO() {
    }

    public BikePropertiesDTO(int bike_property_id) {
        this.bike_property_id = bike_property_id;
    }

    public BikePropertiesDTO(int bike_property_id, ItemsDTO item, String bike_size, String bike_wheel_size, String bike_color, String bike_material, String bike_brake_type, Date created_dt) {
        this.bike_property_id = bike_property_id;
        this.item = item;
